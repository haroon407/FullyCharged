...
class MakeBookingServiceClass {
  ...
  getData(user) {
    ...
    const URL = baseUrl + '/locations/search?sw=48.25653029401251,11.633186874796593&ne=48.27181450576806,11.713309822489464&startDate=2019-07-24&startTime=10&price=0.34';
    return axios(URL, {
      method: 'GET',
      headers: {
