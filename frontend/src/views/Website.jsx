            ...
            <div className="content">
                ...
                <div className="jumbotron">
                    <div className="container">
                        ...
                        <p>
                            We connect EV owners and EV charging providers in order to extend
                            EV usability with integrated charging booking, authorization and
                            payment
                        </p>
                    </div>
                </div>
                ...
                <div className="row info">
                    <div className="col-md-6">
                        ...
                        <ul>
                            <li>
                                Optimal utilization of EV Charging Locations (EVCLs)
                                (Maximized profits)
                            </li>
                            <li>Extensive data logging & visualization</li>
                            <li>Transparent user management & authorization</li>
                            <li>Easy administration & maintenance of EVCLs</li>
                    ...
                    <div className="col-md-6">
                        <h2>EV Owners</h2>
                        <ul>
                            <li>Easy to find suitable & available chargers</li>
                            <li>Compatibility filter for EVCLs</li>
                            <li>Transparent and reduced charging cost</li>
                            <li>Booking for charging</li>
                            <li>Integrated authorization & payment</li>
